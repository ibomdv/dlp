...
# CONSTANTS
# ══════════════════════════════════════════════════════
APP_TITLE       = "DRMLogPlotter rebuild - Version 1.24"
...
class DRMPlotter:
    ...
    def _manage_tx_sites(self):
        ...
        for r, lbl in enumerate(['Service Name','TX Location','Frequency (kHz)']):
            ...
            entries[lbl] = e
        # Max 2 digits for Lat/Lon degrees+minutes (Aug 2026, user
        # request) — same proven validator already used in Setup ->
    ...
    def _set_event(self):
        ...
        if _saved_se_geom:
            try:
                ...
                center_dialog(dlg, self.root, 780, 720)
        else:
            center_dialog(dlg, self.root, 780, 720)
        ...
        def _open_radio_list_for_timer():
            ...
            tk.Label(top2, textvariable=path_var2, bg=GUI_BG, font=('Arial',8),
                     fg='#555555').pack(side=tk.LEFT, padx=(8,0))
            ...
            def _auto_refresh2():
                if not _rl2_alive[0]:
                    return
                refresh_view2()
                _rl2_after_id[0] = rl2.after(60000, _auto_refresh2)
