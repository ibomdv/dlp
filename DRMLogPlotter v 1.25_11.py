...
class DRMPlotter:
    ...
    def _build_text_clock(self, parent, alive_flag):
        """
        ...
        Shared between the Main-GUI's DRM-Radio-List and the
        'Radio-List for Timer-Event' window.
